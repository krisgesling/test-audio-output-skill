...
class TestAudioOutput(MycroftSkill):
    def __init__(self):
        ...
        # self.audio_dir = '/opt/mycroft/skills/test-audio-output-skill'
    ...
    def handle_wav_output_test(self, message):
        ...
        wait_while_speaking()
        play_wav(os.path.join(self.audio_dir, 'audio_test.wav'))
    ...
    def handle_mp3_output_test(self, message):
        ...
        wait_while_speaking()
        play_mp3(os.path.join(self.audio_dir, 'audio_test.mp3'))
    ...
    def handle_ogg_output_test(self, message):
        ...
        wait_while_speaking()
        play_ogg(os.path.join(self.audio_dir, 'audio_test.ogg'))
